alter table journeys
  ...
  add column parent_journey_id uuid references journeys(id) on delete set null;

alter table user_journeys
  add column journey_version_id uuid references journeys(id) on delete set null;
