                  ...
                  <tr className="bg-zinc-50 dark:bg-zinc-800/30">
                    <td colSpan={3} className="px-6 py-6">
                      <div className="space-y-6">
                        {score.feedback && (
                          <div>
                            <h4 className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-2">Feedback</h4>
                        ...
                        {score.criteria && score.criteria.length > 0 && (
                          <div>
                            <h4 className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-3">Dimension Breakdown</h4>
                            <div className="grid gap-3 sm:grid-cols-2">
                              {score.criteria.map((dim, idx) => (
                                <div key={idx} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 p-4 rounded-lg shadow-sm">
                                  <div className="flex justify-between items-start mb-2">
                                    <span className="font-semibold text-zinc-900 dark:text-white">{dim.name}</span>
